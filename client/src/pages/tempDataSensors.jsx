...
const TablePaginationActions = (props) => {
	...
	return (
		<Box sx={{ flexShrink: 0, ml: 2.5 }}>
			...
			>
				{theme.direction === 'rtl' ? <KeyboardArrowRight sx={{ fontSize: 24 }} /> : <KeyboardArrowLeft sx={{ fontSize: 24 }} />}
			</IconButton>
			<IconButton
			...
			>
				{theme.direction === 'rtl' ? <KeyboardArrowLeft sx={{ fontSize: 24 }} /> : <KeyboardArrowRight sx={{ fontSize: 24 }} />}
			</IconButton>
			<IconButton
			...
			<Paper sx={{ width: '100%', mb: 2 }}>
				...
				<TableContainer>
					...
					>
						...
						{/* <TableFooter>
							<TableRow >
								<TablePagination sx={{fontSize: 16, marginLeft: 200}}
